#include"../../src/front/lexical.h"
#include"../../src/front/syntax.h"
#include"../../src/front/semantic.h"
#include"../../src/ir/ir.h"
#include"../../src/tools/ir_executor.h"
...
int main(int argc, char** argv) {
    ...
    */
    ...
    ir::Instruction subInst(
        ir::Operand("p",ir::Type::Int),
        ir::Operand("1",ir::Type::IntLiteral),
        ir::Operand("t1",ir::Type::Int),
        ir::Operator::subi);
    ir::Instruction movInst(
        ir::Operand("t1",ir::Type::Int),
        ir::Operand(),
        ir::Operand("p",ir::Type::Int),
        ir::Operator::mov);
    ...
    ir::CallInst callGlobal(
        ir::Operand("global",ir::Type::null),
        ir::Operand("t0",ir::Type::null));
    ir::Instruction defInst(
        ir::Operand("0",ir::Type::IntLiteral),
        ir::Operand(),
    ...
    ir::CallInst callInst(
        ir::Operand("func",ir::Type::Int),
        paraVec1,
        ir::Operand("t2",ir::Type::Int));
    ir::Instruction movInst2(
        ir::Operand("t2",ir::Type::Int),
        ir::Operand(),
        ir::Operand("b",ir::Type::Int),
        ir::Operator::mov);
    ir::Instruction lssInst(
        ir::Operand("b",ir::Type::Int),
        ir::Operand("a",ir::Type::Int),
        ir::Operand("t3",ir::Type::Int),
        ir::Operator::lss);
    ir::Instruction gotoInst(
        ir::Operand("t3",ir::Type::Int),
        ir::Operand(),
        ir::Operand("2",ir::Type::IntLiteral),
        ir::Operator::_goto);
    ir::Instruction gotoInst1(
        ir::Operand(),
        ir::Operand(),
        ir::Operand("4",ir::Type::IntLiteral),
        ir::Operator::_goto);
    ir::Instruction defInst2(
        ir::Operand("2",ir::Type::IntLiteral),
        ir::Operand(),
        ir::Operand("t4",ir::Type::Int),
        ir::Operator::def);
    ir::Instruction mulInst(
        ir::Operand("b",ir::Type::Int),
        ir::Operand("t4",ir::Type::Int),
        ir::Operand("t5",ir::Type::Int),
        ir::Operator::mul);
    ir::Instruction movInst3(
        ir::Operand("t5",ir::Type::Int),
        ir::Operand(),
        ir::Operand("b",ir::Type::Int),
        ir::Operator::mov);
